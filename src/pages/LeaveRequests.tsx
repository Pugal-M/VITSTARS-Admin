  ...
  return (
    <div className="animate-fade-in">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--spacing-6)' }}>
        <div>
          <h1>STARS Leave Approval</h1>
          <p style={{ color: 'var(--color-text-muted)', marginTop: '-1.25rem' }}>Approve, reject, and review student leave requests</p>
        </div>
      </div>
          ...
          <table className="admin-table">
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={6} style={{ textAlign: 'center', padding: 'var(--spacing-8)' }}>No leave requests found.</td></tr>
              ) : (
